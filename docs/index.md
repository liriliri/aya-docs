...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Windows
      link: https://release.liriliri.io/AYA-1.5.0-win-x64.exe
    - theme: alt
      text: macOS
      link: https://release.liriliri.io/AYA-1.5.0-mac-arm64.dmg 
    - theme: alt
      text: Linux
      link: https://release.liriliri.io/AYA-1.5.0-linux-x86_64.AppImage
  image:
    src: /screenshot.png
    alt: screenshot
