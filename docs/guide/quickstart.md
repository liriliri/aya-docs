...
AYA supports [Windows x64](https://release.liriliri.io/AYA-0.4.1-win-x64.exe), [macOS ARM](https://release.liriliri.io/AYA-0.4.1-mac-arm64.dmg) and [Linux](https://release.liriliri.io/AYA-0.4.1-linux-x86_64.AppImage) platforms. After downloading and installing, simply click the desktop icon to start using it.
