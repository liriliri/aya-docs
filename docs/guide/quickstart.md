...
AYA supports [Windows x64](https://release.liriliri.io/aya/AYA-1.12.1-win-x64.exe), [macOS arm64](https://release.liriliri.io/aya/AYA-1.12.1-mac-arm64.dmg), [macOS x64](https://release.liriliri.io/aya/AYA-1.12.1-mac-x64.dmg) and [Linux](https://release.liriliri.io/aya/AYA-1.12.1-linux-x86_64.AppImage) platforms. After downloading and installing, simply click the desktop icon to start using it.
