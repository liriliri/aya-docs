...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Windows
      link: https://release.liriliri.io/AYA-0.6.1-win-x64.exe
    - theme: alt
      text: macOS
      link: https://release.liriliri.io/AYA-0.6.1-mac-arm64.dmg 
    - theme: alt
      text: Linux
      link: https://release.liriliri.io/AYA-0.6.1-linux-x86_64.AppImage  
  image:
    src: /screenshot.png
    alt: screenshot
