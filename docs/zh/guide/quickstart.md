...
AYA 支持 [Windows x64](https://release.liriliri.io/aya/AYA-1.14.0-win-x64.exe)，[macOS arm64](https://release.liriliri.io/aya/AYA-1.14.0-mac-arm64.dmg)，[macOS x64](https://release.liriliri.io/aya/AYA-1.14.0-mac-x64.dmg) 和 [Linux](https://release.liriliri.io/aya/AYA-1.14.0-linux-x86_64.AppImage) 两个平台，下载安装后直接点击桌面图标开始使用。
